...
public class Contact extends ExampleSupport{
    ...
    private String[] randomMessage = {"This is Another sample message" , "from the Contact Page", "To test out the dynamic pages", "If it really works", "Or im just trippin", "You cant see me! my time is now!"} ;
